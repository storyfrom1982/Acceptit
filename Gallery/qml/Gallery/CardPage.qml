    ...
    Qaterial.Pane
    {
      ...
      ColumnLayout
      {
        ...
        CardLayout3
        {
          ...
          media: "qrc:/qt/qml/Gallery/images/card80x80_1.png"
          // media: "qrc:/images/card80x80_1.png"
        ...
        {
          Layout.fillWidth: true
          media: "qrc:/qt/qml/Gallery/images/card344x194_2.png"
          ...
          button3.icon.source: "qrc:/qt/qml/Gallery/icons/plus.svg"
          button4.icon.source: "qrc:/qt/qml/Gallery/icons/heart.svg"
        } // CardLayout1

        CardLayout2
        {
          Layout.fillWidth: true
          media: "qrc:/qt/qml/Gallery/images/card344x194_3.png"
          thumbnail: "qrc:/qt/qml/Gallery/images/card40x40.png"
          headerText: "Title goes here"
        ...
        ListView
        {
          ...
          {
            media: "qrc:/qt/qml/Gallery/images/card168x168_" + (5 - index) + ".png"
          } // CardLayout4
        } // ListView
        ...
        CardLayout3
        {
          Layout.fillWidth: true
          outlined: true
          media: "qrc:/qt/qml/Gallery/images/card80x80_2.png"
          headerText: "Title goes here"
        ...
        CardLayout1
        {
          Layout.fillWidth: true
          outlined: true
          media: "qrc:/qt/qml/Gallery/images/card344x194_1.png"
          headerText: "Our Changing Planet"
          subHeaderText: "by Kurt Wagner"
          supportingText: "Visit ten places on our planet that are undergoing the biggest changes today."
          button1.text: "Read"
        ...
        ListView
        {
          ...
          delegate: CardLayout4
          {
            media: "qrc:/qt/qml/Gallery/images/card168x168_" + (index + 1) + ".png"
            outlined: true
          } // CardLayout4
        } // ListView
      } // ColumnLayout
