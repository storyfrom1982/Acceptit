...
Qaterial.ScrollablePage
{
  ...
  Column
  {
    ...
    Qaterial.TextFieldDelegate
    {
      ...
      value: dummyText
      icon.source: "qrc:/qt/qml/Gallery/icons/account.svg"
    ...
    Qaterial.TextFieldDelegate
    {
      ...
      secondaryText: dummyText
      value: dummyText
      icon.source: "qrc:/qt/qml/Gallery/icons/cake.svg"
      fillIcon: true
      outlinedIcon: true
    ...
    Qaterial.EnumDelegate
    {
      ...
      model: ListModel
      {
        ListElement { text: "Choice 1";secondaryText: "secondary text";source: "qrc:/qt/qml/Gallery/icons/cake.svg" }
        ListElement { text: "Choice 2";secondaryText: "Neque porro quisquam";source: "qrc:/qt/qml/Gallery/icons/music-note.svg" }
        ListElement { text: "Element 3";secondaryText: "st qui dolorem ipsum";source: "qrc:/qt/qml/Gallery/icons/heart.svg" }
        ListElement { text: "Choice 4";secondaryText: "sNam arcu el" }
        ListElement { text: "Element 5";secondaryText: "tibulum gra" }
        ListElement { text: "Element 6";secondaryText: "sLe Lorem";source: "qrc:/qt/qml/Gallery/icons/phone.svg" }
        ListElement { secondaryText: "quia dolor" }
        ListElement { secondaryText: "secondary text";source: "qrc:/qt/qml/Gallery/icons/wifi.svg" }
        ListElement { text: "Element 9"; }
        ListElement { text: "Element 10"; }
        ListElement { text: "Element 11";source: "qrc:/qt/qml/Gallery/icons/account.svg" }
      } // ListModel
