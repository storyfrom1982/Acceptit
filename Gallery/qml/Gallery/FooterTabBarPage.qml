    ...
    Qaterial.Page
    {
      ...
      footer: Qaterial.TabBar
      {
        ...
        Repeater
        {
          ...
          model: ListModel
          {
            ListElement { text: "Favorites";source: "qrc:/qt/qml/Gallery/icons/heart.svg" }
            ListElement { text: "Music";source: "qrc:/qt/qml/Gallery/icons/music-note.svg" }
            ListElement { text: "Albums";source: "qrc:/qt/qml/Gallery/icons/album.svg" }
            ListElement { text: "Settings";source: "qrc:/qt/qml/Gallery/icons/settings.svg" }
          } // ListModel
